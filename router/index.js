...
const hashPassMiddleware = require('../mid/hashPassMiddle');
...
router.post("/user",isAuth,roleProtection.accessToCreate(Constants.ACTION.CREATE),validationMiddleware,hashPassMiddleware,userController.createUser);
